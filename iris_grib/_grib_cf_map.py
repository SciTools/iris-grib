...
GRIB2_TO_CF = {
    ...
    G2Param(2, 0, 1, 9): CFName('stratiform_rainfall_amount', 'Large-scale precipitation (non-convective)', 'kg m-2'),
    G2Param(2, 0, 1, 10): CFName('convective_rainfall_amount', 'Convective precipitation', 'kg m-2'),
    ...
    G2Param(2, 0, 1, 15): CFName('stratiform_snowfall_amount', 'Large-scale snow', 'kg m-2'),
    G2Param(2, 0, 1, 22): CFName(None, 'cloud_mixing_ratio', 'kg kg-1'),
    G2Param(2, 0, 1, 37): CFName('convective_rainfall_flux', 'Convective precipitation rate', 'kg m-2 s-1'),
    ...
    G2Param(2, 0, 1, 58): CFName('convective_snowfall_flux', 'Convective snowfall rate', 'kg m-2 s-1'),
    G2Param(2, 0, 1, 59): CFName('stratiform_snowfall_flux', 'Large scale snowfall rate', 'kg m-2 s-1'),
    ...
    G2Param(2, 0, 1, 77): CFName('stratiform_rainfall_flux', 'Large scale rain rate', 'kg m-2 s-1'),
    ...
    G2Param(2, 0, 2, 9): CFName('upward_air_velocity', 'Vertical velocity (geometric)', 'm s-1'),
    G2Param(2, 0, 2, 10): CFName('atmosphere_absolute_vorticity', None, 's-1'),
    G2Param(2, 0, 2, 12): CFName('atmosphere_relative_vorticity', 'Relative vorticity', 's-1'),
    ...
    G2Param(2, 0, 5, 4): CFName('toa_outgoing_longwave_flux', 'Upward long-wave radiation flux', 'W m-2'),
    ...
    G2Param(2, 2, 0, 3): CFName('soil_moisture_content', 'Soil moisture content', 'kg m-2'),
