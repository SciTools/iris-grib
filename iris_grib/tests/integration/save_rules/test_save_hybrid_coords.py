...
class TestSaveHybridHeight(tests.IrisGribTest):
    def setUp(self):
        ...
        if hasattr(iris.FUTURE, "netcdf_promote") and not iris.FUTURE.netcdf_promote:
            iris.FUTURE.netcdf_promote = True
        data_cube = iris.load_cube(reference_data_filepath, "air_potential_temperature")
    ...
    def test_save(self):
        ...
        with self.temp_filename() as temp_path:
            ...
            self.assertArrayAllClose(
                ...
                [0, 5.0, 0, 45.0, 0, 111.667, 0, 0.999, 0, 0.995, 0, 0.987],
                atol=0.0015,
            )
            ...
            self.assertEqual(msg.sections[4]["scaleFactorOfFirstFixedSurface"], 0)
            #  first surface value = 3  -- i.e. #2 of (1, 3, 5).
            self.assertEqual(msg.sections[4]["scaledValueOfFirstFixedSurface"], 3)
...
class TestSaveHybridPressure(tests.IrisGribTest):
    def setUp(self):
        reference_data_filepath = self.get_testdata_path("hybrid_pressure.nc")
        data_cube = iris.load_cube(reference_data_filepath, "air_temperature")
    ...
    def test_save(self):
        ...
        with self.temp_filename() as temp_path:
            ...
            pv_expected[[1, 51, 91]] = [0.0, 18191.03, 0.003]
            pv_expected[[93, 143, 183]] = [0.0, 0.036, 0.998]
            self.assertArrayAllClose(msgs[0].sections[4]["pv"], pv_expected, atol=0.001)
            ...
            self.assertEqual(msg.sections[4]["scaleFactorOfFirstFixedSurface"], 0)
            #  first surface value = 3  -- i.e. #2 of (1, 3, 5).
            self.assertEqual(msg.sections[4]["scaledValueOfFirstFixedSurface"], 51)
            #  second surface type = "NONE"  -- i.e. unbounded level.
            self.assertEqual(msg.sections[4]["typeOfSecondFixedSurface"], 255)
