...
"""
Legacy GRIB1 loading, based on :class:`GribWrapper` and :class:`GribDataProxy`.

This loader is now deprecated, the replacement uses the :class:`iris_grib.GribMessage`.
While this mechanism is still in place, the user can switch between the two with the
:data:`iris_grib.GRIB1_LOADING_MODE` switch.
"""
...
from iris_grib import _ASLAZYDATA_NEEDS_META, _make_dask_meta
