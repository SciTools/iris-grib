...
class TestSpatialProcessingIdentifiers(tests.IrisGribTest):
    ...
    def test_cell_method(self, mock_set):
        ...
        mock_set.assert_any_call(
            mock.sentinel.grib, "productDefinitionTemplateNumber", 15
        )
    ...
    def test_bilinear_interpolation(self, mock_set):
        ...
        mock_set.assert_any_call(mock.sentinel.grib, "spatialProcessing", 1)
    ...
    def test_budget_interpolation(self, mock_set):
        ...
        mock_set.assert_any_call(mock.sentinel.grib, "spatialProcessing", 4)
        mock_set.assert_any_call(mock.sentinel.grib, "numberOfPointsUsed", 4)
    ...
    def test_spectral_interpolation(self, mock_set):
        ...
        mock_set.assert_any_call(mock.sentinel.grib, "spatialProcessing", 5)
        mock_set.assert_any_call(mock.sentinel.grib, "numberOfPointsUsed", 4)
    ...
    def test_neighbour_budget_interpolation(self, mock_set):
        ...
        mock_set.assert_any_call(mock.sentinel.grib, "spatialProcessing", 6)
        mock_set.assert_any_call(mock.sentinel.grib, "numberOfPointsUsed", 4)
