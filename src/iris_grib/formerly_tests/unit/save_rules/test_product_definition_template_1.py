...
class TestRealizationIdentifier(tests.IrisGribTest):
    ...
    def test_realization(self, mock_set):
        ...
        mock_set.assert_any_call(
            mock.sentinel.grib, "productDefinitionTemplateNumber", 1
        )
        mock_set.assert_any_call(mock.sentinel.grib, "perturbationNumber", 10)
        mock_set.assert_any_call(mock.sentinel.grib, "numberOfForecastsInEnsemble", 255)
        mock_set.assert_any_call(mock.sentinel.grib, "typeOfEnsembleForecast", 255)
