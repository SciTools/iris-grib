...
class Test_data__masked(tests.IrisGribTest):
    ...
    def test_no_bitmap(self):
        ...
        message = _make_test_message(
            {3: self._section_3, 6: SECTION_6_NO_BITMAP, 7: {"codedValues": values}}
        )
    ...
    def test_bitmap_present(self):
        ...
        message = _make_test_message(
            {
                3: self._section_3,
                6: {"bitMapIndicator": 0, "bitmap": self.bitmap},
    ...
    def test_bitmap__invalid_indicator(self):
        ...
        message = _make_test_message(
            {
                3: self._section_3,
                6: {"bitMapIndicator": 100, "bitmap": None},
                7: {"codedValues": values},
            }
        )
...
class Test_data__unsupported(tests.IrisGribTest):
    def test_unsupported_grid_definition(self):
        message = _make_test_message(
            {3: {"sourceOfGridDefinition": 1}, 6: SECTION_6_NO_BITMAP}
        )
...
class Mixin_data__grid_template(metaclass=ABCMeta):
    ...
    def test_unsupported_scanning_mode(self):
        message = _make_test_message({3: self.section_3(1), 6: SECTION_6_NO_BITMAP})
...
class Test_data__grid_template_0(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
        return _example_section_3(0, scanning_mode)


class Test_data__grid_template_1(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
        return _example_section_3(1, scanning_mode)


class Test_data__grid_template_5(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
        return _example_section_3(5, scanning_mode)


class Test_data__grid_template_12(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
        return _example_section_3(12, scanning_mode)


class Test_data__grid_template_30(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
...
class Test_data__grid_template_40_regular(
    tests.IrisGribTest, Mixin_data__grid_template
):
    def section_3(self, scanning_mode):
        return _example_section_3(40, scanning_mode)


class Test_data__grid_template_90(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
...
class Test_data__grid_template_140(tests.IrisGribTest, Mixin_data__grid_template):
    def section_3(self, scanning_mode):
...
class Test_data__unknown_grid_template(tests.IrisGribTest):
    def test(self):
        ...
        with self.assertRaisesRegex(TranslationError, "template 999 is not supported"):
            _ = message.data
