...
"""
Unit tests for
:func:`iris_grib._grib2_convert.grid_definition_template_140`.
"""
...
from iris_grib._grib2_convert import grid_definition_template_140
...
class Test(tests.IrisGribTest):
    ...
    def expected(self, y_dim, x_dim):
        ...
        ellipsoid = iris.coord_systems.GeogCS(6378137, inverse_flattening=298.257222101)
