...
"""
Tests for function :func:`iris_grib._grib2_convert.statistical_forecast_period`.
...
from iris_grib._grib2_convert import statistical_forecast_period_coord
...
class Test(tests.IrisGribTest):
    def setUp(self):
        ...
        self.patch(module + ".time_range_unit", return_value=self.forecast_units)
