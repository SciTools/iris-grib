...
"""
Test function
:func:`iris_grib._grib2_convert.grid_definition_template_4_and_5`.
...
from iris_grib._grib2_convert import grid_definition_template_4_and_5, _MDI as MDI
...
class Test(tests.IrisGribTest):
    def setUp(self):
        ...
        self.patch("iris_grib._grib2_convert._is_circular", return_value=False)
        self.metadata = {
            "factories": [],
            "references": [],
            "standard_name": None,
