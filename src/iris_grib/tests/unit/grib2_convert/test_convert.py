...
"""Test function :func:`iris_grib._grib2_convert.convert`."""
...
class TestGribMessage(tests.IrisGribTest):
    def test_edition_2(self):
        ...
        this = "iris_grib._grib2_convert.grib2_convert"
...
class TestGribWrapper(tests.IrisGribTest):
    ...
    def test_edition_1(self):
        ...
        func = "iris_grib._grib1_legacy.grib1_load_rules.grib1_convert"
