...
"""
Test function
:func:`iris_grib._grib2_convert.grid_definition_template_5`.
...
from iris_grib._grib2_convert import grid_definition_template_5
...
class Test(tests.IrisGribTest):
    ...
    def test(self):
        ...
        section = {
            "latitudeOfSouthernPole": 45000000,
        ...
        from iris_grib._grib2_convert import (  # noqa: PLC0415
            ellipsoid_geometry,
            ellipsoid,
        ...
        gdt_4_5.assert_called_once_with(
            section, metadata, "grid_latitude", "grid_longitude", self.cs
        )
