...
"""Test function :func:`iris_grib._grib2_convert.grib2_convert`."""
...
import iris_grib
from iris_grib._grib2_convert import grib2_convert
from iris_grib.tests.unit import _make_test_message


class Test(tests.IrisGribTest):
    def setUp(self):
        this = "iris_grib._grib2_convert"
    ...
    def test(self):
        sections = [
            {"discipline": mock.sentinel.discipline},  # section 0
            {
        ...
        args = (
            sections[4],
            expected,
            sections[0]["discipline"],
            sections[1]["tablesVersion"],
            None,
        )
