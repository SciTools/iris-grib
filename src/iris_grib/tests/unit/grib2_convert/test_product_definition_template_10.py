...
"""
Test function :func:`iris_grib._grib2_convert.product_definition_template_10`.
...
from iris_grib._grib2_convert import product_definition_template_10
...
class Test(tests.IrisGribTest):
    ...
    def test_percentile_coord(self):
        ...
        product_definition_template_10(section, metadata, forecast_reference_time)

        expected = {"aux_coords_and_dims": []}
        percentile = DimCoord(
            percentileValue, long_name="percentile_over_time", units="no_unit"
        )
