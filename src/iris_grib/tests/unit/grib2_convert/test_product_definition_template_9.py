...
"""
Tests for function
:func:`iris_grib._grib2_convert.product_definition_template_9`.
...
from iris_grib._grib2_convert import product_definition_template_9
from iris_grib._grib2_convert import Probability, _MDI
...
class Test(tests.IrisGribTest):
    def setUp(self):
        ...
        self.patch_pdt8_call = self.patch(module + ".product_definition_template_8")
