...
"""
Test function
:func:`iris_grib._grib2_convert.product_definition_template_0`.
...
from iris_grib._grib2_convert import product_definition_template_0
...
class Test(LoadConvertTest):
    def test_given_frt(self):
        ...
        aux.append((iris.coords.DimCoord(6, "forecast_period", units="hours"), None))
        aux.append((iris.coords.DimCoord(30, "time", units="hours since epoch"), None))
        aux.append((rt_coord, None))
        aux.append((iris.coords.DimCoord(9999, long_name="height", units="m"), None))
    ...
    def test_generating_process_warnings(self):
        ...
        convert_options = iris_grib._grib2_convert.options
