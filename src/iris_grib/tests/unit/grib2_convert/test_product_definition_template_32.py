...
"""
Tests for `iris_grib._grib2_convert.product_definition_template_32`.
...
from iris_grib._grib2_convert import product_definition_template_32
...
class Test(tests.IrisGribTest):
    def setUp(self):
        ...
        self.generating_process_patch = self.patch(
            "iris_grib._grib2_convert.generating_process"
        )
        self.satellite_common_patch = self.patch(
            "iris_grib._grib2_convert.satellite_common"
        )
        self.time_coords_patch = self.patch("iris_grib._grib2_convert.time_coords")
        self.data_cutoff_patch = self.patch("iris_grib._grib2_convert.data_cutoff")
