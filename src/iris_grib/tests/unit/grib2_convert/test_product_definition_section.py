...
"""
Tests for `iris_grib._grib2_convert.product_definition_section`.
...
from iris_grib._grib2_convert import product_definition_section
from iris_grib.tests.unit.grib2_convert import empty_metadata
from iris_grib.tests.unit.grib2_convert.test_product_definition_template_0 import (
    section_4 as pdt_0_section_4,
)
from iris_grib.tests.unit.grib2_convert.test_product_definition_template_31 import (
    section_4 as pdt_31_section_4,
)
...
class TestFixedSurfaces(tests.IrisGribTest):
    ...
    def setUp(self):
        ...
        self.translate_phenomenon_patch = self.patch(
            "iris_grib._grib2_convert.translate_phenomenon"
        )
    ...
    def _check_fixed_surface(self, fs_is_expected, fs_is_present):
        ...
        if fs_is_expected and not fs_is_present:
            ...
            run_function()
            self.assertEqual(
                self.translate_phenomenon_patch.call_count, previous_call_count + 1
            )
