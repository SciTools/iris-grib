...
"""
Unit tests for :meth:`iris_grib._save_rules.grid_definition_template_1`.
...
from iris_grib._save_rules import grid_definition_template_1
...
class Test(tests.IrisGribTest, GdtTestMixin):
    ...
    def test__shape_of_earth_fixed_6(self):
        ellipsoid = GeogCS(semi_major_axis=6371229)
        cs = RotatedGeogCS(
            grid_north_pole_latitude=90.0,
            grid_north_pole_longitude=0.0,
            ellipsoid=ellipsoid,
